...
def func2Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32, .i32], locals := [.i32, .i32], body := func2, results := [] }
...
def func4Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32], body := func4, results := [] }
...
def func5Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32], body := func5, results := [] }
...
def func6Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32, .i32], body := func6, results := [] }
...
def func10Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32, .i32, .i32, .i32, .i32, .i32, .i32, .i32], body := func10, results := [.i32] }
...
def func11Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32, .i32, .i32, .i32, .i32], body := func11, results := [] }
...
def func12Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32, .i32], body := func12, results := [] }
...
def func14Def : Wasm.Function :=
  { params := [.i32, .i32, .i32], locals := [], body := func14, results := [] }
...
def func15Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32], locals := [], body := func15, results := [.i32] }
...
def func43Def : Wasm.Function :=
  { params := [.i32], locals := [.i32, .i32], body := func43, results := [.i32] }

def func44 : Wasm.Program :=
  [
  .localGet 0,
  .const (0 : UInt32),
  .load64 (1048844 : UInt32),
  .store64 (8 : UInt32),
  .localGet 0,
  .const (0 : UInt32),
...
def func49Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32], body := func49, results := [] }
...
def func50Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [], body := func50, results := [.i32] }
...
def func51Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32, .i32, .i32, .i32, .i32], body := func51, results := [.i32] }
...
def func52Def : Wasm.Function :=
  { params := [.i32, .i32, .i32], locals := [.i32], body := func52, results := [.i32] }
...
def func53Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32, .i64], body := func53, results := [] }
...
def func57Def : Wasm.Function :=
  { params := [.i32, .i32, .i32], locals := [.i32, .i32], body := func57, results := [] }
...
def func61Def : Wasm.Function :=
  { params := [.i32, .i32, .i32], locals := [], body := func61, results := [] }
...
def func62Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32], locals := [.i32, .i64], body := func62, results := [] }
...
def func65Def : Wasm.Function :=
  { params := [.i32, .i32, .i32], locals := [.i32, .i64], body := func65, results := [] }
...
def func66Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32, .i32, .i32], locals := [.i32, .i32, .i32, .i32, .i32, .i32, .i32, .i32, .i64], body := func66, results := [.i32] }
...
def func67Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32, .i32, .i32, .i32, .i32, .i32, .i32], body := func67, results := [.i32] }
...
def func68Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32, .i32], locals := [], body := func68, results := [.i32] }
...
def func69Def : Wasm.Function :=
  { params := [.i32, .i32, .i32], locals := [], body := func69, results := [.i32] }
...
def func70Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32, .i32, .i32, .i32, .i32, .i32], body := func70, results := [.i32] }
...
def «module» : Wasm.Module :=
{
  ...
  elements := [
    { tableIdx := some 0, offset := some 1, funcs := [some 28, some 20, some 52, some 51, some 56, some 50, some 49, some 47, some 48, some 21, some 46, some 54, some 53, some 55, some 45, some 44, some 70] }
  ]
}

...
def func0Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32, .i32, .i32, .i32, .i32, .i32, .i32], body := func0, results := [] }
...
def func1Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32], locals := [], body := func1, results := [] }
...
def func2Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32, .i32], body := func2, results := [] }
...
def func54Def : Wasm.Function :=
  { params := [.i32, .i32, .i32], locals := [.i32, .i64], body := func54, results := [] }
...
def func55Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32, .i32, .i32], locals := [.i32, .i32, .i32, .i32, .i32, .i32, .i32, .i32, .i64], body := func55, results := [.i32] }
...
def func56Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32, .i32, .i32, .i32, .i32, .i32, .i32], body := func56, results := [.i32] }
...
def func57Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32, .i32], locals := [], body := func57, results := [.i32] }
...
def func59Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32, .i32, .i32, .i32, .i32, .i32], body := func59, results := [.i32] }
...
def «module» : Wasm.Module :=
{
  ...
  elements := [
    { tableIdx := some 0, offset := some 1, funcs := [some 18, some 10, some 42, some 41, some 46, some 40, some 39, some 37, some 38, some 11, some 36, some 44, some 43, some 45, some 35, some 34, some 59] }
  ]
}
